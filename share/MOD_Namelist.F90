...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   ! irrigation allocation method
   integer :: DEF_IRRIGATION_ALLOCATION = 1 !1:no limited supply; 2:default irrigation allocated order; 3:FAO irrigation allocated fraction
   integer :: DEF_IRRIGATION_METHOD = 2

   !  photosynthesis stress option
   LOGICAL :: DEF_USE_NOSTRESSNITROGEN = .false.

   logical :: DEF_optimization_crop = .false.
   ...
   logical            :: DEF_USE_CNSOYFIXN = .false.
   !Fire MODULE
...
! ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   type history_var_type
      ...
      logical :: fsen_roof    = .false.
      logical :: fsen_wsun    = .false.
      logical :: fsen_wsha    = .false.
      logical :: fsen_gimp    = .false.
      logical :: fsen_gper    = .false.
      logical :: fsen_urbl    = .false.
      logical :: lfevp_roof   = .false.
      logical :: lfevp_gimp   = .false.
      logical :: lfevp_gper   = .false.
      logical :: lfevp_urbl   = .false.
      logical :: fhac         = .false.
      logical :: fwst         = .false.
      logical :: fach         = .false.
      logical :: fhah         = .false.
      logical :: meta         = .false.
      logical :: vehc         = .false.
      logical :: t_room       = .false.
      logical :: tafu         = .false.
      logical :: t_roof       = .false.
      logical :: t_wall       = .false.
      ...
      logical :: leafc              = .false.
      logical :: leafc_storage      = .false.
      logical :: leafc_xfer         = .false.
      logical :: frootc             = .false.
      logical :: frootc_storage     = .false.
      logical :: frootc_xfer        = .false.
      logical :: livestemc          = .false.
      logical :: livestemc_storage  = .false.
      logical :: livestemc_xfer     = .false.
      logical :: deadstemc          = .false.
      logical :: deadstemc_storage  = .false.
      logical :: deadstemc_xfer     = .false.
      logical :: livecrootc         = .false.
      logical :: livecrootc_storage = .false.
      logical :: livecrootc_xfer    = .false.
      logical :: deadcrootc         = .false.
      logical :: deadcrootc_storage = .false.
      logical :: deadcrootc_xfer    = .false.
      logical :: grainc             = .false.
      logical :: grainc_storage     = .false.
      logical :: grainc_xfer        = .false.
      logical :: leafn              = .false.
      logical :: leafn_storage      = .false.
      logical :: leafn_xfer         = .false.
      logical :: frootn             = .false.
      logical :: frootn_storage     = .false.
      logical :: frootn_xfer        = .false.
      logical :: livestemn          = .false.
      logical :: livestemn_storage  = .false.
      logical :: livestemn_xfer     = .false.
      logical :: deadstemn          = .false.
      logical :: deadstemn_storage  = .false.
      logical :: deadstemn_xfer     = .false.
      logical :: livecrootn         = .false.
      logical :: livecrootn_storage = .false.
      logical :: livecrootn_xfer    = .false.
      logical :: deadcrootn         = .false.
      logical :: deadcrootn_storage = .false.
      logical :: deadcrootn_xfer    = .false.
      logical :: grainn             = .false.
      logical :: grainn_storage     = .false.
      logical :: grainn_xfer        = .false.
      logical :: retrasn            = .false.
      logical :: gpp                = .true.
      logical :: downreg            = .false.
      logical :: ar                 = .true.
      logical :: cwdprod            = .false.
      logical :: cwddecomp          = .false.
      logical :: hr                 = .false.
      logical :: fpg                = .true.
      logical :: fpi                = .true.
      ...
      logical :: plantdate_rainfed_temp_corn= .false.
      logical :: plantdate_irrigated_temp_corn= .false.
      logical :: plantdate_rainfed_spwheat= .false.
      logical :: plantdate_irrigated_spwheat= .false.
      logical :: plantdate_rainfed_wtwheat= .false.
      logical :: plantdate_irrigated_wtwheat= .false.
      logical :: plantdate_rainfed_temp_soybean= .false.
      logical :: plantdate_irrigated_temp_soybean= .false.
      logical :: plantdate_rainfed_cotton= .false.
      logical :: plantdate_irrigated_cotton= .false.
      logical :: plantdate_rainfed_rice= .false.
      logical :: plantdate_irrigated_rice= .false.
      logical :: plantdate_rainfed_sugarcane= .false.
      logical :: plantdate_irrigated_sugarcane= .false.
      logical :: plantdate_rainfed_trop_corn= .false.
      logical :: plantdate_irrigated_trop_corn= .false.
      logical :: plantdate_rainfed_trop_soybean= .false.
      logical :: plantdate_irrigated_trop_soybean= .false.
      logical :: plantdate_unmanagedcrop= .false.

      logical :: maturitydate_rainfed_temp_corn= .false.
      logical :: maturitydate_irrigated_temp_corn= .false.
      logical :: maturitydate_rainfed_spwheat= .false.
      logical :: maturitydate_irrigated_spwheat= .false.
      logical :: maturitydate_rainfed_wtwheat= .false.
      logical :: maturitydate_irrigated_wtwheat= .false.
      logical :: maturitydate_rainfed_temp_soybean= .false.
      logical :: maturitydate_irrigated_temp_soybean= .false.
      logical :: maturitydate_rainfed_cotton= .false.
      logical :: maturitydate_irrigated_cotton= .false.
      logical :: maturitydate_rainfed_rice= .false.
      logical :: maturitydate_irrigated_rice= .false.
      logical :: maturitydate_rainfed_sugarcane= .false.
      logical :: maturitydate_irrigated_sugarcane= .false.
      logical :: maturitydate_rainfed_trop_corn= .false.
      logical :: maturitydate_irrigated_trop_corn= .false.
      logical :: maturitydate_rainfed_trop_soybean= .false.
      logical :: maturitydate_irrigated_trop_soybean= .false.
      logical :: maturitydate_unmanagedcrop= .false.
      ...
      logical :: fertnitro_corn     = .false.
      logical :: fertnitro_swheat   = .false.
      logical :: fertnitro_wwheat   = .false.
      logical :: fertnitro_soybean  = .false.
      logical :: fertnitro_cotton   = .false.
      logical :: fertnitro_rice1    = .false.
      logical :: fertnitro_rice2    = .false.
      logical :: fertnitro_sugarcane= .false.
      logical :: irrig_method_corn     = .false.
      logical :: irrig_method_swheat   = .false.
      logical :: irrig_method_wwheat   = .false.
      logical :: irrig_method_soybean  = .false.
      logical :: irrig_method_cotton   = .false.
      logical :: irrig_method_rice1    = .false.
      logical :: irrig_method_rice2    = .false.
      logical :: irrig_method_sugarcane= .false.
      ...
      logical :: groundwater_supply_rn = .true.
      logical :: groundwater_supply_nrn = .true.
      logical :: reservoirriver_demand  = .true.
      logical :: reservoirriver_supply  = .true.

      logical :: irrig_demand_days     = .true.
      logical :: irrig_supply_satisfy_days  = .true.
      logical :: irrig_supply_unsatisfy_days  = .true.
      ...
      logical :: litr1c_vr    = .false.
      logical :: litr2c_vr    = .false.
      logical :: litr3c_vr    = .false.
      logical :: soil1c_vr    = .false.
      logical :: soil2c_vr    = .false.
      logical :: soil3c_vr    = .false.
      logical :: cwdc_vr      = .false.
      logical :: litr1n_vr    = .false.
      logical :: litr2n_vr    = .false.
      logical :: litr3n_vr    = .false.
      logical :: soil1n_vr    = .false.
      logical :: soil2n_vr    = .false.
      logical :: soil3n_vr    = .false.
      logical :: cwdn_vr      = .false.
      logical :: sminn_vr     = .false.
...
CONTAINS
   ...
   namelist /nl_colm/          &
      ...
      DEF_IRRIGATION_ALLOCATION,       &   ! irrigation allocated method   
      DEF_IRRIGATION_METHOD,           &   ! irrigation method
      DEF_USE_NOSTRESSNITROGEN,        &   ! no stress nitrogen in photosynthesis
      DEF_optimization_crop,           &   ! optimization crop
...
! ===============================================================
      ...
      CALL mpi_bcast (DEF_IRRIGATION_ALLOCATION, 1, mpi_integer, p_root, p_comm_glb, p_err)
      CALL mpi_bcast (DEF_IRRIGATION_METHOD, 1, mpi_integer, p_root, p_comm_glb, p_err)
      CALL mpi_bcast (DEF_USE_NOSTRESSNITROGEN, 1, mpi_logical, p_root, p_comm_glb, p_err)
      CALL mpi_bcast (DEF_optimization_crop, 1, mpi_logical, p_root, p_comm_glb, p_err)
      ...
      DO ivar = 1, 8
         ...
         CALL mpi_bcast (DEF_forcing%timelog(ivar)  ,256, mpi_character ,p_root ,p_comm_glb ,p_err)
   ...
   logical, intent(in) :: set_defaults
      ...
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_rainfed_temp_corn     , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_irrigated_temp_corn   , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_rainfed_spwheat       , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_irrigated_spwheat     , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_rainfed_wtwheat       , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_irrigated_wtwheat     , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_rainfed_temp_soybean  , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_irrigated_temp_soybean, set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_rainfed_cotton        , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_irrigated_cotton      , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_rainfed_rice          , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_irrigated_rice        , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_rainfed_sugarcane     , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_irrigated_sugarcane   , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_rainfed_trop_corn     , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_irrigated_trop_corn   , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_rainfed_trop_soybean  , set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_irrigated_trop_soybean, set_defaults)
      CALL sync_hist_vars_one (DEF_hist_vars%maturitydate_unmanagedcrop         , set_defaults)
      ...
      IF(DEF_USE_IRRIGATION)THEN
         ...
         CALL sync_hist_vars_one (DEF_hist_vars%groundwater_supply_rn           , set_defaults)
         CALL sync_hist_vars_one (DEF_hist_vars%groundwater_supply_nrn          , set_defaults)
         ...
         call sync_hist_vars_one (DEF_hist_vars%irrig_demand_days               , set_defaults)
         call sync_hist_vars_one (DEF_hist_vars%irrig_supply_satisfy_days       , set_defaults)
         call sync_hist_vars_one (DEF_hist_vars%irrig_supply_unsatisfy_days     , set_defaults)
      ENDIF
#endif
