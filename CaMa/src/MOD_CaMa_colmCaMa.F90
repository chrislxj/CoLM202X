...
CONTAINS
   ...
   integer(KIND=JPIM)          :: JF
      ...
      CALL mpi_bcast (LDAMIRR  ,   1, MPI_LOGICAL,  p_root, p_comm_glb, p_err)  ! switch for deficit irrigation
      ...
      CALL mpi_bcast (real_WEST,   1, mpi_real8,   p_root, p_comm_glb, p_err) ! number of grid points in x-direction of CaMa-Flood
      CALL mpi_bcast (real_EAST,   1, mpi_real8,   p_root, p_comm_glb, p_err) ! number of grid points in x-direction of CaMa-Flood
      CALL mpi_bcast (real_SOUTH,   1, mpi_real8,   p_root, p_comm_glb, p_err) ! number of grid points in x-direction of CaMa-Flood
      CALL mpi_bcast (real_NORTH,   1, mpi_real8,   p_root, p_comm_glb, p_err) ! number of grid points in x-direction of CaMa-Flood
...
#ifdef CROP
      CALL mp2g_cama%build (landpatch, gcama, pctshrpch) !build the mapping between cama and mpi
#else
