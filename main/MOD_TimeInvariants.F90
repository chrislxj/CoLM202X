...
! surface classification and soil information
  ...
  real(r8), allocatable :: dpond          (:)  ! depth to bedrock
#endif
...
#ifdef VARIABLY_SATURATED_FLOW
     call ncio_read_vector (file_restart, 'dpond   ' ,    landpatch, dpond   ) !
#endif
...
#ifdef VARIABLY_SATURATED_FLOW
     call ncio_write_vector (file_restart, 'dpond   ' , 'vector', landpatch, dpond   ) !
#endif
...
#ifdef VARIABLY_SATURATED_FLOW
      call check_vector_data ('dpond       ', dpond       ) !
#endif
