...
! !USES:
   ...
   integer, parameter :: nnormal              = 25 ! normal crop
   integer, parameter :: nirrig_normal        = 26 ! irrigated normal crop
   ...
   integer , parameter :: irrig_time_per_day = 86400         ! irrigation last time
