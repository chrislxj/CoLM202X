...
! --------------------- SASU variables -----------------------------
  REAL(r8), allocatable :: leafc0_p                 (:) ! SASU pinup initial value: leaf display C (gC m-2)
  REAL(r8), allocatable :: leafc0_storage_p         (:) ! SASU pinup initial value: leaf storage C (gC m-2)
  REAL(r8), allocatable :: leafc0_xfer_p            (:) ! SASU pinup initial value: leaf transfer C (gC m-2)
  REAL(r8), allocatable :: frootc0_p                (:) ! SASU pinup initial value: fine root display C (gC m-2)
  REAL(r8), allocatable :: frootc0_storage_p        (:) ! SASU pinup initial value: fine root storage C (gC m-2)
  REAL(r8), allocatable :: frootc0_xfer_p           (:) ! SASU pinup initial value: fine root transfer C (gC m-2)
  REAL(r8), allocatable :: livestemc0_p             (:) ! SASU pinup initial value: live stem display C (gC m-2)
  REAL(r8), allocatable :: livestemc0_storage_p     (:) ! SASU pinup initial value: live stem storage C (gC m-2)
  REAL(r8), allocatable :: livestemc0_xfer_p        (:) ! SASU pinup initial value: live stem transfer C (gC m-2)
  REAL(r8), allocatable :: deadstemc0_p             (:) ! SASU pinup initial value: dead stem display C (gC m-2)
  REAL(r8), allocatable :: deadstemc0_storage_p     (:) ! SASU pinup initial value: dead stem storage C (gC m-2)
  REAL(r8), allocatable :: deadstemc0_xfer_p        (:) ! SASU pinup initial value: dead stem transfer C (gC m-2)
  REAL(r8), allocatable :: livecrootc0_p            (:) ! SASU pinup initial value: live coarse root display C (gC m-2)
  REAL(r8), allocatable :: livecrootc0_storage_p    (:) ! SASU pinup initial value: live coarse root storage C (gC m-2)
  REAL(r8), allocatable :: livecrootc0_xfer_p       (:) ! SASU pinup initial value: live coarse root transfer C (gC m-2)
  REAL(r8), allocatable :: deadcrootc0_p            (:) ! SASU pinup initial value: dead coarse root display C (gC m-2)
  REAL(r8), allocatable :: deadcrootc0_storage_p    (:) ! SASU pinup initial value: dead coarse root storage C (gC m-2)
  REAL(r8), allocatable :: deadcrootc0_xfer_p       (:) ! SASU pinup initial value: dead coarse root transfer C (gC m-2)
  REAL(r8), allocatable :: grainc0_p                (:) ! SASU pinup initial value: grain display C (gC m-2)
  REAL(r8), allocatable :: grainc0_storage_p        (:) ! SASU pinup initial value: grain storage C (gC m-2)
  REAL(r8), allocatable :: grainc0_xfer_p           (:) ! SASU pinup initial value: grain transfer C (gC m-2)

  REAL(r8), allocatable :: leafn0_p                 (:) ! SASU pinup initial value: leaf display N (gN m-2)
  REAL(r8), allocatable :: leafn0_storage_p         (:) ! SASU pinup initial value: leaf storage N (gN m-2)
  REAL(r8), allocatable :: leafn0_xfer_p            (:) ! SASU pinup initial value: leaf transfer N (gN m-2)
  REAL(r8), allocatable :: frootn0_p                (:) ! SASU pinup initial value: fine root display N (gN m-2)
  REAL(r8), allocatable :: frootn0_storage_p        (:) ! SASU pinup initial value: fine root storage N (gN m-2)
  REAL(r8), allocatable :: frootn0_xfer_p           (:) ! SASU pinup initial value: fine root transfer N (gN m-2)
  REAL(r8), allocatable :: livestemn0_p             (:) ! SASU pinup initial value: live stem display N (gN m-2)
  REAL(r8), allocatable :: livestemn0_storage_p     (:) ! SASU pinup initial value: live stem storage N (gN m-2)
  REAL(r8), allocatable :: livestemn0_xfer_p        (:) ! SASU pinup initial value: live stem transfer N (gN m-2)
  REAL(r8), allocatable :: deadstemn0_p             (:) ! SASU pinup initial value: dead stem display N (gN m-2)
  REAL(r8), allocatable :: deadstemn0_storage_p     (:) ! SASU pinup initial value: dead stem storage N (gN m-2)
  REAL(r8), allocatable :: deadstemn0_xfer_p        (:) ! SASU pinup initial value: dead stem transfer N (gN m-2)
  REAL(r8), allocatable :: livecrootn0_p            (:) ! SASU pinup initial value: live coarse root display N (gN m-2)
  REAL(r8), allocatable :: livecrootn0_storage_p    (:) ! SASU pinup initial value: live coarse root storage N (gN m-2)
  REAL(r8), allocatable :: livecrootn0_xfer_p       (:) ! SASU pinup initial value: live coarse root transfer N (gN m-2)
  REAL(r8), allocatable :: deadcrootn0_p            (:) ! SASU pinup initial value: dead coarse root display N (gN m-2)
  REAL(r8), allocatable :: deadcrootn0_storage_p    (:) ! SASU pinup initial value: dead coarse root storage N (gN m-2)
  REAL(r8), allocatable :: deadcrootn0_xfer_p       (:) ! SASU pinup initial value: dead coarse root transfer N (gN m-2)
  REAL(r8), allocatable :: grainn0_p                (:) ! SASU pinup initial value: grain display N (gN m-2)
  REAL(r8), allocatable :: grainn0_storage_p        (:) ! SASU pinup initial value: grain storage N (gN m-2)
  REAL(r8), allocatable :: grainn0_xfer_p           (:) ! SASU pinup initial value: grain transfer N (gN m-2)
  REAL(r8), allocatable :: retransn0_p              (:) ! SASU pinup initial value: retranslocated N (gN m-2)
