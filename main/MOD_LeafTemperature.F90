...
! vegetation parameters
   ...
   integer , intent(in) :: c3c4 ! 1: C3, 2: C4
         ...
         IF(lai .gt. 0.001) THEN
            ...
            IF (DEF_USE_PLANTHYDRAULICS) THEN
               ...
               CALL update_photosyn(tl, po2m, pco2m, pco2a, parsun, psrf, rstfacsun, rb, gssun, &
                                    effcon, vmax25, c3c4, gradm, trop, slti, hlti, shti, hhti, trda, trdm, cintsun, &
                                    assimsun, respcsun)

               CALL update_photosyn(tl, po2m, pco2m, pco2a, parsha, psrf, rstfacsha, rb, gssha, &
                                    effcon, vmax25, c3c4, gradm, trop, slti, hlti, shti, hhti, trda, trdm, cintsha, &
                                    assimsha, respcsha)
